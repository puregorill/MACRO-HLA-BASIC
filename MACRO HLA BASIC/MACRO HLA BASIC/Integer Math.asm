...
!macro ADD16 target_addr_mode, target_value, source0_addr_mode, source0_operand, source1_addr_mode, source1_operand {
  !if source1_addr_mode<=IMM16 { ; 16-bit
    ...
    +_S_T_A_H_I_ target_addr_mode, target_value
  } else { ; 8-bit
    +_L_D_A_ source0_addr_mode, source0_operand
    +ADD8_TO_A source1_addr_mode, source1_operand
    +_S_T_A_ target_addr_mode, target_value
    bcc ._l_
    +_I_N_C_H_I_ target_addr_mode, target_value
    ._l_
  }
}
!macro SUB16 target_addr_mode, target_value, source0_addr_mode, source0_operand, source1_addr_mode, source1_operand {
  !if source1_addr_mode<=IMM16 { ; 16-bit
    +_L_D_A_ source0_addr_mode, source0_operand
    +SUB8_FROM_A source1_addr_mode, source1_operand
    +_S_T_A_ target_addr_mode, target_value
    ...
    +_S_T_A_ target_addr_mode, target_value
    bcs ._l_
    +_D_E_C_H_I_ target_addr_mode, target_value
    ._l_
  }
}
