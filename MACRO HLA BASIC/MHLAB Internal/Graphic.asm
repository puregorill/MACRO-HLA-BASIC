...
;-------------------------------------------------------------------------------------------------
; "position" | ora | bits     | charmem address + current VIC bank
;  in $d018  |     |          | hex        dez
;-------------------------------------------------------------------------------------------------
; 0          |  0  | xxxx000x | $0000      0
; 1          |  2  | xxxx001x | $0800      2048
; 2          |  4  | xxxx010x | $1000      4096  CHARROM image in Bank 0 & 2 (default: UpGfx CharSet)
; 3          |  6  | xxxx011x | $1800      6144  CHARROM image in Bank 0 & 2 (LoUp CharSet)
...
!macro VICBANK vic_bank {  
  ...
  !if vic_bank=3 {
    ...
    ora #%00000001 ; (with CHARROM image)
  } else {
    ora #%00000011 ; default bank 0 (with CHARROM image)
